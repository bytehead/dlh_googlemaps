...
class ContentMap extends \ContentElement
{
    ...
    protected function compile()
    {
        ...
        else
        {
            ...
            $GLOBALS['TL_JAVASCRIPT'][] = 'http'.(\Environment::get('ssl') ? 's' : '').'://maps.google.com/maps/api/js?key='.$arrMap['apiKey'].'&amp;language='.$arrMap['language'].'&amp;sensor='. ($arrMap['sensor'] ? 'true':'false');
        }
